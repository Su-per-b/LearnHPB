...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://www.learnhpb.org/schemas/hpb" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;variablelist&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="Building.xsd" namespace="http://www.learnhpb.org/schemas/hpb"/>
	...
	<xsl:template name="altova:Root">
		<html>
			<head>
				...
				<style type="text/css">
					<xsl:comment>@import  url("styles.css");</xsl:comment>
				</style>
			...
			<body>
				...
				<xsl:for-each select="$XML">
					...
					<xsl:for-each select="n1:SystemList">
						<xsl:for-each select="n1:System">
							...
							<xsl:for-each select="n1:SubSystem">
								<div class="level2">
									<xsl:for-each select="@name">
										<span>
											<xsl:value-of select="string(.)"/>
								...
								<xsl:for-each select="n1:Category">
									...
									<xsl:for-each select="n1:Variable">
	...
	<xsl:template name="Variable">
		<div class="variable">
				...
				<table border="1">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<xsl:for-each select="@variability">
									<span>
										<xsl:value-of select="string(.)"/>
									</span>
								</xsl:for-each>
			...
			<xsl:for-each select="n1:Integer">
				<xsl:variable name="altova:table">
					<table border="1">
			...
			<xsl:for-each select="n1:Decimal">
				<xsl:variable name="altova:table">
					<table border="1">
			...
			<xsl:for-each select="n1:OptionList">
				<div class="optionlist">
					<xsl:variable name="altova:table">
						<table border="1" class="fakeheader">
							<xsl:variable name="altova:CurrContextGrid_3" select="."/>
							<xsl:variable name="altova:ColumnData"/>
							<tbody>
								<tr>
									<td style="width:5.13in; ">
										<span>
