...
goog.inherits(lgb.scenario.model.SysVar, lgb.core.BaseModel);


/**
 * @param {Node} node Used to construct this object.
 */
lgb.scenario.model.SysVar.prototype.parse = function(node) {
 ...
 */
lgb.scenario.model.SysVar.prototype.setValue = function(name, type, content) {
    //throw ("Test");
