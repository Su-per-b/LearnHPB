...
goog.inherits(sim.BaseClass, goog.events.EventTarget);
 ...
 */
sim.BaseClass.prototype.d = function(theFunction, arg) {
  var delegate;
 ...
 */
sim.BaseClass.prototype.dispatchLocal = function(event) {
 ...
 */
sim.BaseClass.prototype.listen = function(eventType, handler) {
  return this.listenHelper_(sim.globalEventBus, eventType, this, handler);
};
 ...
 * @return {?number} the event handler key.
 */
sim.BaseClass.prototype.listenTo = function(eventTarget, eventType, handler) {
 ...
 * @return {?number} the event handler key.
 */
sim.BaseClass.prototype.listenHelper_ = function(
 ...
 * @param {!Function} handler Function that will be called when the event fires.
 */
sim.BaseClass.prototype.listenOnce = function(eventType, handler) {
  this.listenOnceHelper_(sim.globalEventBus, eventType, this, handler);
};
 ...
 * @param {!Function} handler Function that will be called when the event fires.
 */
sim.BaseClass.prototype.listenToOnce = function(
 ...
 * @private
 */
sim.BaseClass.prototype.listenOnceHelper_ = function(
  eventTarget, eventType, handlerContext, handler) {
 ...
 * @protected
 */
sim.BaseClass.prototype.each = function(ary, handler) {
  var l = ary.length;
  for (var i = 0; i < l; i++) {
    var arg = ary[i];
 ...
 */
sim.BaseClass.prototype.unlisten = function(key) {
