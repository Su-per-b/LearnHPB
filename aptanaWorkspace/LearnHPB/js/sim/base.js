 ...
 * Then you can call them like this - sim.init();
 ...
 */
sim.init = function() {
  sim.console = new goog.debug.Console();
};
 ...
 */
sim.logInfo = function(msg, loggerName) {
  sim.logHelper_(msg, loggerName, goog.debug.Logger.Level.INFO);
};
 ...
 * @param {string=} loggerName This will display as a kind of label.
 */
sim.logWarning = function(msg, loggerName) {
  sim.logHelper_(msg, loggerName, goog.debug.Logger.Level.WARNING);
};
 ...
 * @param {string=} loggerName This will display as a kind of label.
 */
sim.logSevere = function(msg, loggerName) {
  sim.logHelper_(msg, loggerName, goog.debug.Logger.Level.SEVERE);
};
...
sim.logHelper_ = function(msg, loggerName, level) {
  ...
  var logRecord = new goog.debug.LogRecord(level, msg, loggerName);
   ...
   sim.console.addLogRecord(logRecord);
};
 ...
 */
sim.convertFeetToMeters = function(feet) {
