 ...
 */
sim.utils.notNull = function(value) {
  return !sim.utils.isNull(value);
};
 ...
 */
sim.utils.isNull = function(value) {
 ...
 */
sim.utils.preload = function(images) {
    var i = 0;
...
*
*/
sim.utils.validateArgs = function(arrayOfTypes, expectedArgCount) {
  //get the parameters of the function that is executing validArgs
  var args = sim.utils.validateArgs.caller.arguments,
    len = args.length;
