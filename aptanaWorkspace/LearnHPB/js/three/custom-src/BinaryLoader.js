...
THREE.BinaryLoader.prototype.createBinModel = function ( data, callback, texturePath, materials ) {
 ...
 //   var materials = scope.initMaterials( materials, texturePath );
  
  
		materials = THREE.Loader.prototype.initMaterials(materials, texturePath );
...
*/
		...
		if ( THREE.Loader.prototype.needsTangents( this ) ) this.computeTangents();
	...
	function uv4 ( where, u1, v1, u2, v2, u3, v3, u4, v4 ) {
		...
		uv.push( new THREE.Vector2( u2, v2 ) );
		uv.push( new THREE.Vector2( u3, v3 ) );
		uv.push( new THREE.Vector2( u4, v4 ) );
		where.push( uv );
