...
goog.provide('test.world.controller.WorldController');
 ...
 * when we render 3D.
 */
test.world.controller.WorldController = function() {
  lgb.core.BaseController.call(this);
  this.parentHtmlID = lgb.core.Config.HUD_CONTAINER_STR;
};
goog.inherits(test.world.controller.WorldController, lgb.core.BaseController);


/**
 * Initializes the WorldController Controller after the document is ready
 */
test.world.controller.WorldController.prototype.init = function() {
   ...
   * @type {test.world.controller.CameraController}
   * @private
  **/
 ...
 * @private
 */
test.world.controller.WorldController.prototype.initLights_ = function() {
  /**
   * light source 1
 ...
 * @private
 */
test.world.controller.WorldController.prototype.initRenderer_ = function() {
  /**
 ...
 * @private
 */
test.world.controller.WorldController.prototype.bind_ = function() {
...
test.world.controller.WorldController.prototype.onLayoutChange_ = function(event) {
  this.calculateSize_();
};
 ...
 */
test.world.controller.WorldController.prototype.onAddToWorldRequest_ = function(event) {
 ...
 * @private
 */
test.world.controller.WorldController.prototype.calculateSize_ = function() {
 ...
 */
test.world.controller.WorldController.prototype.onRenderOReq_ = function(timestamp) {
  window.oRequestAnimationFrame(worldController.onRenderOReq_);
  worldController.renderHelper(timestamp);
};
 ...
 * @param {number} timestamp A timestamp.
 */
test.world.controller.WorldController.prototype.onRenderMoz_ = function(timestamp) {

  window.mozRequestAnimationFrame(worldController.onRenderMoz_);
  worldController.renderHelper(timestamp);
};
 ...
 * @param {number} timestamp A timestamp.
 */
test.world.controller.WorldController.prototype.onRenderWebkit_ = function(timestamp) {

  window.webkitRequestAnimationFrame(
      worldController.onRenderWebkit_
    );
 ...
 * @param {number} timestamp A timestamp.
 */
test.world.controller.WorldController.prototype.onRenderMisc_ = function(timestamp) {

  window.requestAnimationFrame(worldController.onRenderMisc_);
  worldController.renderHelper(timestamp);
};
 ...
 * @param {number} timestamp A timestamp.
 */
test.world.controller.WorldController.prototype.renderHelper = function(timestamp) {
