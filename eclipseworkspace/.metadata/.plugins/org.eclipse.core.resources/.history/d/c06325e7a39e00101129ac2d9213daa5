...
var lgb = (function(lgb) {
	...
	lgb.view.gui.makeViewpoints = function(){
		...
		var delegateClick = $.proxy(this.onViewPointClick,this);
		var delegateMouseOver = $.proxy(this.onViewPointMouseOver,this);
		var delegateMouseOut = $.proxy(this.onViewPointMouseOut,this);
		...
		for(var i=0; i < 10; i++) {
			...
			jqSelector.click(eventPayload, delegateClick);
			jqSelector.mouseover(eventPayload, delegateMouseOver);
			jqSelector.mouseout(eventPayload, delegateMouseOut);
		}
	};
