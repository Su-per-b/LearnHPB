...
var hemi = (function(hemi) {
	...
	var createIntervalFcn = function() {
		//console.log ('createIntervalFcn');
		if (intervalId == null) {
			intervalId = window.setInterval(function(){
				//console.log ('window.setInterval fired');
				...
				for (var ndx = 0, len = keys.length; ndx < len; ndx++) {
					...
					var progressInfoSoFar = loadInfo.getKnownProgressInfoSoFar();
					
					// check for finished (may have finished very quickly)
					fileObj.percent = loadInfo.request_ == null ? 0 : 
						progressInfoSoFar.percent;
	...
	var updateTotal = function() {
		...
		//var loadInfo = fileObj.loadInfo;
		//var progressInfoSoFar = loadInfo.getKnownProgressInfoSoFar();
		//console.log ('updateTotal()progressInfoSoFar.downloaded: ' + progressInfoSoFar.downloaded);
		//console.log ('updateTotal()progressInfoSoFar.totalBytes: ' + progressInfoSoFar.totalBytes);
	...
	hemi.loader.loadModel = function(url, pack, parent, opt_callback, opt_options) {
		...
		hemi.world.loader.loadScene(hemi.core.client, pack, parent, url,
			...
			//this fuction is called afer the o3d libs load the scene
