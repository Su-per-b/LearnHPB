...
var lgb = (function(lgb) {
	...
	lgb.view.ZoneView.prototype = {
		...
		init: function(floor5Model) {
			...
			this.dataModel.coreLongSide = this.dataModel.longSide - (this.dataModel.cornerWidth *2);
			this.dataModel.coreShortSide = this.dataModel.shortSide - (this.dataModel.cornerHeight *2);
