...
var mainController = (function(mainController) {
	...
	mainController.onMeshesLoaded = function(event) {
		...
		var newEvent = jQuery.Event(lgb.event.Event.ALL_MESHES_LOADED);
...
/*
	...
	mainController.handleEvent = function(func, context, eventName) {
		var newEvent = jQuery.Event(eventName);
		$('body').trigger(newEvent);
	};
...
*/
	...
	mainController.setViewPoint = function() {
		...
		//mainController.centerModelToOrigin(floor1Model);
