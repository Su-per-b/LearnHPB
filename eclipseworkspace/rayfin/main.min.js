var COMPILED=!0,goog=goog||{};goog.global=this;goog.DEBUG=!0;goog.LOCALE="en";goog.provide=function(a){if(!COMPILED){console.log("goog.provide: "+a);if(goog.isProvided_(a))throw Error('Namespace "'+a+'" already declared.');delete goog.implicitNamespaces_[a];for(var b=a;b=b.substring(0,b.lastIndexOf("."));){if(goog.getObjectByName(b))break;goog.implicitNamespaces_[b]=!0}}goog.exportPath_(a)};
...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;c==0&&g<f;g++){var h=d[g]||"",j=e[g]||"",l=RegExp("(\\d*)(\\D*)","g"),m=RegExp("(\\d*)(\\D*)","g");do{var n=l.exec(h)||["","",""],i=m.exec(j)||["","",""];if(n[0].length==0&&i[0].length==0)break;var c=n[1].length==0?0:parseInt(n[1],10),r=i[1].length==0?0:parseInt(i[1],10),c=goog.string.compareElements_(c,r)||goog.string.compareElements_(n[2].length==
0,i[2].length==0)||goog.string.compareElements_(n[2],i[2])}while(c==0)}return c};goog.string.compareElements_=function(a,b){if(a<b)return-1;else if(a>b)return 1;return 0};goog.string.HASHCODE_MAX_=4294967296;goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c),b%=goog.string.HASHCODE_MAX_;return b};goog.string.uniqueStringCounter_=Math.random()*2147483648|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};
...
goog.array.binarySearch=function(a,b,c){return goog.array.binarySearch_(a,c||goog.array.defaultCompare,!1,b)};goog.array.binarySelect=function(a,b,c){return goog.array.binarySearch_(a,b,!0,void 0,c)};goog.array.binarySearch_=function(a,b,c,d,e){for(var f=0,g=a.length,h;f<g;){var j=f+g>>1,l;l=c?b.call(e,a[j],j,a):b(d,a[j]);l>0?f=j+1:(g=j,h=!l)}return h?f:~f};goog.array.sort=function(a,b){goog.asserts.assert(a.length!=null);goog.array.ARRAY_PROTOTYPE_.sort.call(a,b||goog.array.defaultCompare)};
...
goog.debug.entryPointRegistry.unmonitorAllIfPossible=function(a){var b=goog.debug.entryPointRegistry.monitors_;goog.asserts.assert(a==b[b.length-1],"Only the most recent monitor can be unwrapped.");for(var a=goog.bind(a.unwrap,a),c=0;c<goog.debug.entryPointRegistry.refList_.length;c++)goog.debug.entryPointRegistry.refList_[c](a);b.length--};goog.debug.errorHandlerWeakDep={protectEntryPoint:function(a){return a}};goog.userAgent={};goog.userAgent.ASSUME_IE=!1;goog.userAgent.ASSUME_GECKO=!1;goog.userAgent.ASSUME_WEBKIT=!1;goog.userAgent.ASSUME_MOBILE_WEBKIT=!1;goog.userAgent.ASSUME_OPERA=!1;goog.userAgent.BROWSER_KNOWN_=goog.userAgent.ASSUME_IE||goog.userAgent.ASSUME_GECKO||goog.userAgent.ASSUME_MOBILE_WEBKIT||goog.userAgent.ASSUME_WEBKIT||goog.userAgent.ASSUME_OPERA;goog.userAgent.getUserAgentString=function(){return goog.global.navigator?goog.global.navigator.userAgent:null};goog.userAgent.getNavigator=function(){return goog.global.navigator};
...
goog.userAgent.isDocumentMode=function(a){return goog.userAgent.isDocumentModeCache_[a]||(goog.userAgent.isDocumentModeCache_[a]=goog.userAgent.IE&&document.documentMode&&document.documentMode>=a)};goog.events={};goog.events.BrowserFeature={HAS_W3C_BUTTON:!goog.userAgent.IE||goog.userAgent.isDocumentMode(9),SET_KEY_CODE_TO_PREVENT_DEFAULT:goog.userAgent.IE&&!goog.userAgent.isVersion("8")};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.ENABLE_MONITORING&&(goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.ENABLE_MONITORING=!1;goog.Disposable.instances_={};goog.Disposable.getUndisposedObjects=function(){var a=[],b;for(b in goog.Disposable.instances_)goog.Disposable.instances_.hasOwnProperty(b)&&a.push(goog.Disposable.instances_[Number(b)]);return a};goog.Disposable.clearUndisposedObjects=function(){goog.Disposable.instances_={}};goog.Disposable.prototype.disposed_=!1;
...
goog.Disposable.prototype.registerDisposable=function(a){if(!this.dependentDisposables_)this.dependentDisposables_=[];this.dependentDisposables_.push(a)};goog.Disposable.prototype.disposeInternal=function(){this.dependentDisposables_&&goog.disposeAll.apply(null,this.dependentDisposables_)};goog.dispose=function(a){a&&typeof a.dispose=="function"&&a.dispose()};goog.disposeAll=function(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];goog.isArrayLike(d)?goog.disposeAll.apply(null,d):goog.dispose(d)}};goog.events.Event=function(a,b){goog.Disposable.call(this);this.type=a;this.currentTarget=this.target=b};goog.inherits(goog.events.Event,goog.Disposable);goog.events.Event.prototype.disposeInternal=function(){delete this.type;delete this.target;delete this.currentTarget};goog.events.Event.prototype.propagationStopped_=!1;goog.events.Event.prototype.returnValue_=!0;goog.events.Event.prototype.stopPropagation=function(){this.propagationStopped_=!0};
...
BEFOREPASTE:"beforepaste",MESSAGE:"message",CONNECT:"connect"};goog.reflect={};goog.reflect.object=function(a,b){return b};goog.reflect.sinkValue=function(a){goog.reflect.sinkValue[" "](a);return a};goog.reflect.sinkValue[" "]=goog.nullFunction;goog.reflect.canAccessProperty=function(a,b){try{return goog.reflect.sinkValue(a[b]),!0}catch(c){}return!1};goog.events.BrowserEvent=function(a,b){a&&this.init(a,b)};goog.inherits(goog.events.BrowserEvent,goog.events.Event);goog.events.BrowserEvent.MouseButton={LEFT:0,MIDDLE:1,RIGHT:2};goog.events.BrowserEvent.IEButtonMap=[1,4,2];goog.events.BrowserEvent.prototype.target=null;goog.events.BrowserEvent.prototype.relatedTarget=null;goog.events.BrowserEvent.prototype.offsetX=0;goog.events.BrowserEvent.prototype.offsetY=0;goog.events.BrowserEvent.prototype.clientX=0;
...
goog.userAgent.jscript.HAS_JSCRIPT=goog.userAgent.jscript.ASSUME_NO_JSCRIPT?!1:goog.userAgent.jscript.DETECTED_HAS_JSCRIPT_;goog.userAgent.jscript.VERSION=goog.userAgent.jscript.ASSUME_NO_JSCRIPT?"0":goog.userAgent.jscript.DETECTED_VERSION_;goog.userAgent.jscript.isVersion=function(a){return goog.string.compareVersions(goog.userAgent.jscript.VERSION,a)>=0};goog.events.pools={};goog.events.ASSUME_GOOD_GC=!1;
...
function(a){h.releaseObject(a)};goog.events.pools.getArray=function(){return j.getObject()};goog.events.pools.releaseArray=function(a){j.releaseObject(a)};goog.events.pools.getProxy=function(){return l.getObject()};goog.events.pools.releaseProxy=function(){l.releaseObject(c())};goog.events.pools.getListener=function(){return m.getObject()};goog.events.pools.releaseListener=function(a){m.releaseObject(a)};goog.events.pools.getEvent=function(){return n.getObject()};goog.events.pools.releaseEvent=function(a){n.releaseObject(a)};
var h=new goog.structs.SimplePool(0,600);h.setCreateObjectFn(a);var j=new goog.structs.SimplePool(0,600);j.setCreateObjectFn(b);var l=new goog.structs.SimplePool(0,600);l.setCreateObjectFn(c);var m=new goog.structs.SimplePool(0,600);m.setCreateObjectFn(d);var n=new goog.structs.SimplePool(0,600);n.setCreateObjectFn(e)}else goog.events.pools.getObject=a,goog.events.pools.releaseObject=goog.nullFunction,goog.events.pools.getArray=b,goog.events.pools.releaseArray=goog.nullFunction,goog.events.pools.getProxy=
c,goog.events.pools.releaseProxy=goog.nullFunction,goog.events.pools.getListener=d,goog.events.pools.releaseListener=goog.nullFunction,goog.events.pools.getEvent=e,goog.events.pools.releaseEvent=goog.nullFunction})();goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.events.cleanUp_=function(a,b,c,d){if(!d.locked_&&d.needsCleanup_){for(var e=0,f=0;e<d.length;e++)if(d[e].removed){var g=d[e].proxy;g.src=null;goog.events.pools.releaseProxy(g);goog.events.pools.releaseListener(d[e])}else e!=f&&(d[f]=d[e]),f++;d.length=f;d.needsCleanup_=!1;f==0&&(goog.events.pools.releaseArray(d),delete goog.events.listenerTree_[a][b][c],goog.events.listenerTree_[a][b].count_--,goog.events.listenerTree_[a][b].count_==0&&(goog.events.pools.releaseObject(goog.events.listenerTree_[a][b]),
...
goog.events.fireListeners_=function(a,b,c,d,e){var f=1,b=goog.getUid(b);if(a[b]){a.remaining_--;a=a[b];a.locked_?a.locked_++:a.locked_=1;try{for(var g=a.length,h=0;h<g;h++){var j=a[h];j&&!j.removed&&(f&=goog.events.fireListener(j,e)!==!1)}}finally{a.locked_--,goog.events.cleanUp_(c,d,b,a)}}return Boolean(f)};goog.events.fireListener=function(a,b){var c=a.handleEvent(b);a.callOnce&&goog.events.unlistenByKey(a.key);return c};goog.events.getTotalListenerCount=function(){return goog.object.getCount(goog.events.listeners_)};
goog.events.dispatchEvent=function(a,b){var c=b.type||b,d=goog.events.listenerTree_;if(!(c in d))return!0;if(goog.isString(b))b=new goog.events.Event(b,a);else if(b instanceof goog.events.Event)b.target=b.target||a;else{var e=b,b=new goog.events.Event(c,a);goog.object.extend(b,e)}var e=1,f,d=d[c],c=!0 in d,g;if(c){f=[];for(g=a;g;g=g.getParentEventTarget())f.push(g);g=d[!0];g.remaining_=g.count_;for(var h=f.length-1;!b.propagationStopped_&&h>=0&&g.remaining_;h--)b.currentTarget=f[h],e&=goog.events.fireListeners_(g,
...
goog.events.handleBrowserEvent_=function(a,b){if(!goog.events.listeners_[a])return!0;var c=goog.events.listeners_[a],d=c.type,e=goog.events.listenerTree_;if(!(d in e))return!0;var e=e[d],f,g;if(goog.events.synthesizeEventPropagation_()){f=b||goog.getObjectByName("window.event");var h=!0 in e,j=!1 in e;if(h){if(goog.events.isMarkedIeEvent_(f))return!0;goog.events.markIeEvent_(f)}var l=goog.events.pools.getEvent();l.init(f,this);f=!0;try{if(h){for(var m=goog.events.pools.getArray(),n=l.currentTarget;n;n=
n.parentNode)m.push(n);g=e[!0];g.remaining_=g.count_;for(var i=m.length-1;!l.propagationStopped_&&i>=0&&g.remaining_;i--)l.currentTarget=m[i],f&=goog.events.fireListeners_(g,m[i],d,!0,l);if(j){g=e[!1];g.remaining_=g.count_;for(i=0;!l.propagationStopped_&&i<m.length&&g.remaining_;i++)l.currentTarget=m[i],f&=goog.events.fireListeners_(g,m[i],d,!1,l)}}else f=goog.events.fireListener(c,l)}finally{if(m)m.length=0,goog.events.pools.releaseArray(m);l.dispose();goog.events.pools.releaseEvent(l)}return f}d=
new goog.events.BrowserEvent(b,this);try{f=goog.events.fireListener(c,d)}finally{d.dispose()}return f};goog.events.pools.setProxyCallbackFunction(goog.events.handleBrowserEvent_);goog.events.markIeEvent_=function(a){var b=!1;if(a.keyCode==0)try{a.keyCode=-1;return}catch(c){b=!0}if(b||a.returnValue==void 0)a.returnValue=!0};goog.events.isMarkedIeEvent_=function(a){return a.keyCode<0||a.returnValue!=void 0};goog.events.uniqueIdCounter_=0;goog.events.getUniqueId=function(a){return a+"_"+goog.events.uniqueIdCounter_++};
...
goog.events.EventTarget.prototype.addEventListener=function(a,b,c,d){goog.events.listen(this,a,b,c,d)};goog.events.EventTarget.prototype.removeEventListener=function(a,b,c,d){goog.events.unlisten(this,a,b,c,d)};goog.events.EventTarget.prototype.dispatchEvent=function(a){return goog.events.dispatchEvent(this,a)};goog.events.EventTarget.prototype.disposeInternal=function(){goog.events.EventTarget.superClass_.disposeInternal.call(this);goog.events.removeAll(this);this.parentEventTarget_=null};var lgb={BaseClass:function(){}};lgb.BaseClass.prototype.d=function(a){return $.proxy(a,this)};lgb.BaseClass.prototype.d=function(a){return $.proxy(a,this)};lgb.BaseClass.prototype.dispatch=function(a){lgb.EventBusObj.dispatch(a)};lgb.BaseClass.prototype.dispatchLocal=function(){};lgb.BaseClass.prototype.listen=function(a,b){var c=jQuery.proxy(b,this);goog.events.listen(lgb.EventBusObj,a,c)};lgb.BaseClass.prototype.each=function(a,b){for(var c=a.length,d=0;d<c;d++)b.apply(this,[a[d]])};
lgb.BaseClass.prototype.eachArg=function(a){for(var b=this.eachArg.caller.arguments,c=b.length,d=0;d<c;d++)a.apply(this,[b[d]])};lgb.BaseClass.prototype.unlisten=function(){};lgb.BaseClass.prototype.assertType=function(a){null===a||void 0===a?jQuery.error("Error when calling assertType expectedType is null or undefined"):!this instanceof a&&jQuery.error("Error when calling assertType object is not of the expected type")};lgb.controller={};lgb.controller.ControllerBase=function(){lgb.BaseClass.call(this)};goog.inherits(lgb.controller.ControllerBase,lgb.BaseClass);goog.events.EventHandler=function(a){goog.Disposable.call(this);this.handler_=a;this.keys_=[]};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(a,b,c,d,e){if(!goog.isArray(b))goog.events.EventHandler.typeArray_[0]=b,b=goog.events.EventHandler.typeArray_;for(var f=0;f<b.length;f++)this.keys_.push(goog.events.listen(a,b[f],c||this,d||!1,e||this.handler_||this));return this};
...
PHANTOM:255};
goog.events.KeyCodes.isTextModifyingKeyEvent=function(a){if(a.altKey&&!a.ctrlKey||a.metaKey||a.keyCode>=goog.events.KeyCodes.F1&&a.keyCode<=goog.events.KeyCodes.F12)return!1;switch(a.keyCode){case goog.events.KeyCodes.ALT:case goog.events.KeyCodes.CAPS_LOCK:case goog.events.KeyCodes.CONTEXT_MENU:case goog.events.KeyCodes.CTRL:case goog.events.KeyCodes.DOWN:case goog.events.KeyCodes.END:case goog.events.KeyCodes.ESC:case goog.events.KeyCodes.HOME:case goog.events.KeyCodes.INSERT:case goog.events.KeyCodes.LEFT:case goog.events.KeyCodes.MAC_FF_META:case goog.events.KeyCodes.META:case goog.events.KeyCodes.NUMLOCK:case goog.events.KeyCodes.NUM_CENTER:case goog.events.KeyCodes.PAGE_DOWN:case goog.events.KeyCodes.PAGE_UP:case goog.events.KeyCodes.PAUSE:case goog.events.KeyCodes.PHANTOM:case goog.events.KeyCodes.PRINT_SCREEN:case goog.events.KeyCodes.RIGHT:case goog.events.KeyCodes.SHIFT:case goog.events.KeyCodes.UP:case goog.events.KeyCodes.WIN_KEY:case goog.events.KeyCodes.WIN_KEY_RIGHT:return!1;default:return!0}};
...
default:return!1}};lgb.controller.MainController=function(){lgb.controller.ControllerBase.call(this);lgb.EventBusObj=new lgb.event.Ebus;var a=$.proxy(this.init,this);jQuery(document).ready(a)};goog.inherits(lgb.controller.MainController,lgb.controller.ControllerBase);lgb.controller.MainController.prototype.d=function(a){return $.proxy(a,this)};
lgb.controller.MainController.prototype.init=function(){this.mouse={x:0,y:0};this.meshes=[];this.theta=0;this.camdist=500;this.totalColliders=this.totalFaces=0;this.infoDiv_=document.getElementById("info");this.containerDiv_=document.createElement("div");this.renderer_=new THREE.WebGLRenderer;this.projector_=new THREE.Projector;this.scene_=new THREE.Scene;this.camera_=new THREE.Camera(2,window.innerWidth/window.innerHeight,1,1E4);this.ambientLight_=new THREE.AmbientLight(6316128);this.sun_=new THREE.DirectionalLight(16777215);
this.stats_=new Stats;this.stats_.domElement.style.position="absolute";this.stats_.domElement.style.top="0px";this.containerDiv_.appendChild(this.stats_.domElement);this.renderer_.setSize(window.innerWidth,window.innerHeight);this.camera_.position.z=this.camdist;this.sun_.position=this.camera_.position.clone();this.scene_.addLight(this.sun_);this.scene_.addLight(this.ambientLight_);this.addLine();this.containerDiv_.appendChild(this.renderer_.domElement);document.body.appendChild(this.containerDiv_);
this.listen(lgb.controller.LoaderController.GeometryLoadedEvent.TYPE,this.onGeometryLoaded);this.containerDiv_.onmousemove=this.d(this.onDocumentMouseMove);this.animate();this.loaderController_=new lgb.controller.LoaderController;this.loaderController_.loadAll()};
lgb.controller.MainController.prototype.addLine=function(){var a=new THREE.LineBasicMaterial({color:16711680,opacity:1,linewidth:3}),b=new THREE.Geometry;b.vertices.push(new THREE.Vertex(new THREE.Vector3(-100,0,0)));b.vertices.push(new THREE.Vertex(new THREE.Vector3(100,0,0)));line=new THREE.Line(b,a);this.scene_.addObject(line)};lgb.controller.MainController.prototype.onGeometryLoaded=function(a){a=a.payload.geometry;this.addOneMesh(new THREE.Vector3(0,0,0),a)};
lgb.controller.MainController.prototype.addOneMesh=function(a,b){this.totalFaces+=b.faces.length;this.totalColliders++;var c=new THREE.Mesh(b,new THREE.MeshPhongMaterial({color:13056}));c.position=a;this.scene_.addObject(c);var d=THREE.CollisionUtils.MeshColliderWBox(c);THREE.Collisions.colliders.push(d);this.meshes.push(c)};
lgb.controller.MainController.prototype.animate=function(){var a=this.d(this.animate);requestAnimationFrame(a);a=new THREE.Vector3(this.mouse.x,this.mouse.y,0.5);this.projector_.unprojectVector(a,this.camera_);a=new THREE.Ray(this.camera_.position,a.subSelf(this.camera_.position).normalize());if(this.meshes.length!==0){var b,c=this.meshes.length;for(b=0;b<c;b++)this.meshes[b].materials[0].color.setHex(13056);this.infoDiv_.innerHTML="";(b=THREE.Collisions.rayCastNearest(a))?(this.infoDiv_.innerHTML+=
"<br />Found @ normal "+this.vts(b.normal),a=a.origin.clone().addSelf(a.direction.clone().multiplyScalar(b.distance)),line.geometry.vertices[0].position=a,line.geometry.vertices[1].position=a.clone().addSelf(b.normal.multiplyScalar(100)),line.geometry.__dirtyVertices=!0,line.geometry.__dirtyElements=!0,b.mesh.materials[0].color.setHex(12255232)):this.infoDiv_.innerHTML+="<br />No intersection";this.camera_.position.x=this.camdist*Math.cos(this.theta);this.camera_.position.z=this.camdist*Math.sin(this.theta);
this.camera_.position.y=this.camdist/2*Math.sin(this.theta*2);this.sun_.position.copy(this.camera_.position);this.sun_.position.normalize();this.theta+=0.0050;this.renderer_.render(this.scene_,this.camera_);this.stats_.update()}};lgb.controller.MainController.prototype.onDocumentMouseMove=function(a){a.preventDefault();this.mouse.x=a.clientX/window.innerWidth*2-1;this.mouse.y=-(a.clientY/window.innerHeight)*2+1};
lgb.controller.MainController.prototype.vts=function(a){return a?a.x.toFixed(2)+" , "+a.y.toFixed(2)+" , "+a.z.toFixed(2)+"<br>":"undefined<br>"};lgb.Config={};console.log("loaded Config");lgb=function(a){a.Config=function(){};a.Config.DEBUG_EVENTS=!0;a.Config.ASSETS_BASE_PATH="3d-assets/";a.Config.XML_BASE_PATH="xml/";a.Config.APP_TITLE="Learn Grean Buildings - Demo 9";a.Config.APP_VERSION="0.09.03";a.Config.BACKGROUND_COLOR=[0.7,0.8,1,1];a.Config.getTitle=function(){return"{0} - v{1}".format(a.Config.APP_TITLE,a.Config.APP_VERSION)};return a}(lgb||{});console.log("parsed Config");lgb.controller.LoaderController=function(){lgb.controller.ControllerBase.call(this);this.binaryLoader_=new THREE.BinaryLoader};goog.inherits(lgb.controller.LoaderController,lgb.controller.ControllerBase);lgb.controller.LoaderController.prototype.loadAll=function(){this.loadMesh("damper-solo.obj.min.js")};lgb.controller.LoaderController.prototype.loadMesh=function(a){this.binaryLoader_.load({model:lgb.Config.ASSETS_BASE_PATH+a,callback:this.d(this.onGeometryLoaded)})};
lgb.controller.LoaderController.prototype.onGeometryLoaded=function(a){this.dispatch(new lgb.controller.LoaderController.GeometryLoadedEvent(a))};lgb.controller.LoaderController.prototype.load=function(){var a=document.createElement("div");document.body.appendChild(a);this.jasonLoader=new THREE.JSONLoader;this.renderer=new THREE.WebGLRenderer;this.renderer.setSize(window.innerWidth,window.innerHeight);a.appendChild(this.renderer.domElement);this.loadMesh()};
lgb.controller.LoaderController.prototype.addOneMesh=function(a,b){this.totalFaces+=b.faces.length;this.totalColliders++;var c=new THREE.Mesh(b,new THREE.MeshPhongMaterial({color:13056}));c.position=a;this.scene.addObject(c);var d=THREE.CollisionUtils.MeshColliderWBox(c);THREE.Collisions.colliders.push(d);this.meshes.push(c)};
lgb.controller.LoaderController.GeometryLoadedEvent=function(a){goog.events.Event.call(this,lgb.controller.LoaderController.GeometryLoadedEvent.TYPE);this.payload={};this.payload.geometry=a};goog.inherits(lgb.controller.LoaderController.GeometryLoadedEvent,goog.events.Event);lgb.controller.LoaderController.GeometryLoadedEvent.TYPE=goog.events.getUniqueId("GeometryLoadedEvent");lgb.event={};lgb.event.Ebus=function(){goog.events.EventTarget.call(this)};goog.inherits(lgb.event.Ebus,goog.events.EventTarget);lgb.event.Ebus.prototype.dispatch=function(a){goog.events.dispatchEvent(this,a)};lgb.Global={};console.log("loaded Global");
Array.prototype.assertContainsType=function(a){if(null===this||void 0===this)jQuery.error("Error in lgb.utils.validateTypeInArray array is null or undefined");else if(!this.constructor==Array)jQuery.error("Error in lgb.utils.validateTypeInArray ary not actually instanceof array");else if(this.length<1)jQuery.error("Error in lgb.utils.validateTypeInArray array length is less than one");else if(null===a||void 0===a)jQuery.error("Error in lgb.utils.validateTypeInArray expectedType is null or undefined");else for(var b=
this.length,c=0;c<b;c++)!this[c]instanceof a&&jQuery.error("Error in lgb.utils.validateTypeInArray expectedType is not the expected type")};String.prototype.format=function(){var a=arguments;return this.replace(/\{\{|\}\}|\{(\d+)\}/g,function(b,c){return b=="{{"?"{":b=="}}"?"}":a[c]})};
Function.prototype.inheritsFrom=function(a){var b=[],c=[],d;for(d in this.prototype)b.push(d),c.push(this.prototype[d]);a.constructor==Function?(this.prototype=new a,this.prototype.constructor=this,this.prototype.parent=a.prototype):(this.prototype=a,this.prototype.constructor=this,this.prototype.parent=a);a=0;for(d=c.length;a<d;a++)this.prototype[b[a]]=c[a];return this};
...
var Stats=function(){function a(a,b,c){var d,e,f;for(e=0;e<30;e++)for(d=0;d<73;d++)f=(d+e*74)*4,a[f]=a[f+4],a[f+1]=a[f+5],a[f+2]=a[f+6];for(e=0;e<30;e++)f=(73+e*74)*4,e<b?(a[f]=k[c].bg.r,a[f+1]=k[c].bg.g,a[f+2]=k[c].bg.b):(a[f]=k[c].fg.r,a[f+1]=k[c].fg.g,a[f+2]=k[c].fg.b)}var b=0,c,d=0,e=(new Date).getTime(),f=e,g=e,h=0,j=1E3,l=0,m,n,i,r,v,s=0,w=1E3,x=0,o,p,t,y,q,u,k={fps:{bg:{r:16,g:16,b:48},fg:{r:0,g:255,b:255}},ms:{bg:{r:16,g:48,b:16},fg:{r:0,g:255,b:0}},mb:{bg:{r:48,g:16,b:26},fg:{r:255,g:0,b:128}}};
c=document.createElement("div");c.style.cursor="pointer";c.style.width="80px";c.style.opacity="0.9";c.style.zIndex="10001";c.addEventListener("click",function(){b++;b==2&&(b=0);m.style.display="none";o.style.display="none";q.style.display="none";switch(b){case 0:m.style.display="block";break;case 1:o.style.display="block";break;case 2:q.style.display="block"}},!1);m=document.createElement("div");m.style.backgroundColor="rgb("+Math.floor(k.fps.bg.r/2)+","+Math.floor(k.fps.bg.g/2)+","+Math.floor(k.fps.bg.b/
2)+")";m.style.padding="2px 0px 3px 0px";c.appendChild(m);n=document.createElement("div");n.style.fontFamily="Helvetica, Arial, sans-serif";n.style.textAlign="left";n.style.fontSize="9px";n.style.color="rgb("+k.fps.fg.r+","+k.fps.fg.g+","+k.fps.fg.b+")";n.style.margin="0px 0px 1px 3px";n.innerHTML='<span style="font-weight:bold">FPS</span>';m.appendChild(n);i=document.createElement("canvas");i.width=74;i.height=30;i.style.display="block";i.style.marginLeft="3px";m.appendChild(i);r=i.getContext("2d");
r.fillStyle="rgb("+k.fps.bg.r+","+k.fps.bg.g+","+k.fps.bg.b+")";r.fillRect(0,0,i.width,i.height);v=r.getImageData(0,0,i.width,i.height);o=document.createElement("div");o.style.backgroundColor="rgb("+Math.floor(k.ms.bg.r/2)+","+Math.floor(k.ms.bg.g/2)+","+Math.floor(k.ms.bg.b/2)+")";o.style.padding="2px 0px 3px 0px";o.style.display="none";c.appendChild(o);p=document.createElement("div");p.style.fontFamily="Helvetica, Arial, sans-serif";p.style.textAlign="left";p.style.fontSize="9px";p.style.color=
"rgb("+k.ms.fg.r+","+k.ms.fg.g+","+k.ms.fg.b+")";p.style.margin="0px 0px 1px 3px";p.innerHTML='<span style="font-weight:bold">MS</span>';o.appendChild(p);i=document.createElement("canvas");i.width=74;i.height=30;i.style.display="block";i.style.marginLeft="3px";o.appendChild(i);t=i.getContext("2d");t.fillStyle="rgb("+k.ms.bg.r+","+k.ms.bg.g+","+k.ms.bg.b+")";t.fillRect(0,0,i.width,i.height);y=t.getImageData(0,0,i.width,i.height);q=document.createElement("div");q.style.backgroundColor="rgb("+Math.floor(k.mb.bg.r/
2)+","+Math.floor(k.mb.bg.g/2)+","+Math.floor(k.mb.bg.b/2)+")";q.style.padding="2px 0px 3px 0px";q.style.display="none";c.appendChild(q);i=document.createElement("div");i.style.fontFamily="Helvetica, Arial, sans-serif";i.style.textAlign="left";i.style.fontSize="9px";i.style.color="rgb("+k.mb.fg.r+","+k.mb.fg.g+","+k.mb.fg.b+")";i.style.margin="0px 0px 1px 3px";i.innerHTML='<span style="font-weight:bold">MB</span>';q.appendChild(i);i=document.createElement("canvas");i.width=74;i.height=30;i.style.display=
"block";i.style.marginLeft="3px";q.appendChild(i);u=i.getContext("2d");u.fillStyle="#301010";u.fillRect(0,0,i.width,i.height);u.getImageData(0,0,i.width,i.height);return{domElement:c,update:function(){d++;e=(new Date).getTime();s=e-f;w=Math.min(w,s);x=Math.max(x,s);a(y.data,Math.min(30,30-s/200*30),"ms");p.innerHTML='<span style="font-weight:bold">'+s+" MS</span> ("+w+"-"+x+")";t.putImageData(y,0,0);f=e;if(e>g+1E3)h=Math.round(d*1E3/(e-g)),j=Math.min(j,h),l=Math.max(l,h),a(v.data,Math.min(30,30-h/
100*30),"fps"),n.innerHTML='<span style="font-weight:bold">'+h+" FPS</span> ("+j+"-"+l+")",r.putImageData(v,0,0),g=e,d=0}}};console.log("parsed Global");var lgbEventBus={};
