 ...
 */
	...
	unit1.step_3 = function(clientElements) {
		...
		var result = hemi.world.camera.unsubscribe(testObj.readySubscription, hemi.msg.ready);
	...
	unit1.step_4 = function(clientElements) {
		...
		var result = hemi.world.camera.unsubscribe(testObj.cameraStopSubscription, hemi.msg.stop);
	...
	testObj.boundingBox = function()   {
		...
		var boundingBox = testObj.model.getBoundingBox();
		...
		jqMock.assertThat( testObj.model.root.boundingBox.minExtent, [-308.3550109863281, -766.7760009765625, -315.0270080566406]);
		jqMock.assertThat( testObj.model.root.boundingBox.maxExtent, [681.6920166015625, 334.6929931640625, 439.8169860839844]);
	...
	testObj.init = function()   {
		...
		testObj.model = new hemi.model.Model();				// Create a new Model
	//	jqMock.assertThat(testObj.model , is.instanceOf(hemi.model.Model));
		
		testObj.model.setFileName('house_v12/scene.json'); // Set the model file
		
		testObj.readySubscription = hemi.world.subscribe(
			hemi.msg.ready,
			unit1,
			'step_3'
		);
	...
	testObj.setupScene = function()   {
		...
		testObj.cameraStopSubscription = hemi.world.camera.subscribe(
				hemi.msg.stop,
				unit1,
				'step_4');
